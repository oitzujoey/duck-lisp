...
dl_error_t duckLisp_cst_append(duckLisp_t *duckLisp, duckLisp_cst_compoundExpression_t *cst, const dl_ptrdiff_t index, dl_bool_t throwErrors) {
	dl_error_t e = dl_error_ok;
	dl_error_t eError = dl_error_ok;
...
dl_error_t duckLisp_ast_append(duckLisp_t *duckLisp, duckLisp_ast_compoundExpression_t *ast,
							 duckLisp_cst_compoundExpression_t *cst, const dl_ptrdiff_t index, dl_bool_t throwErrors) {
	(void) index;
	dl_error_t e = dl_error_ok;
	dl_error_t eError = dl_error_ok;
...
dl_error_t duckLisp_emit_cons(duckLisp_t *duckLisp, dl_array_t *assembly, const dl_ptrdiff_t source_index1, const dl_ptrdiff_t source_index2) {
	dl_error_t e = dl_error_ok;
...
dl_error_t duckLisp_emit_multiply(duckLisp_t *duckLisp, dl_array_t *assembly, const dl_ptrdiff_t source_index1, const dl_ptrdiff_t source_index2) {
	dl_error_t e = dl_error_ok;
...
dl_error_t duckLisp_emit_divide(duckLisp_t *duckLisp, dl_array_t *assembly, const dl_ptrdiff_t source_index1, const dl_ptrdiff_t source_index2) {
	dl_error_t e = dl_error_ok;
...
dl_error_t duckLisp_emit_sub(duckLisp_t *duckLisp, dl_array_t *assembly, const dl_ptrdiff_t source_index1, const dl_ptrdiff_t source_index2) {
	dl_error_t e = dl_error_ok;
...
dl_error_t duckLisp_emit_pushSymbol(duckLisp_t *duckLisp, dl_array_t *assembly, dl_ptrdiff_t *stackIndex, dl_size_t id, char *string, dl_size_t string_length) {
	dl_error_t e = dl_error_ok;
	dl_error_t eError = dl_error_ok;
...
dl_error_t duckLisp_emit_call(duckLisp_t *duckLisp, dl_array_t *assembly, char *label, const dl_size_t label_length, const dl_size_t count) {
	dl_error_t e = dl_error_ok;
	dl_error_t eError = dl_error_ok;
	dl_array_t eString;
	/**/ dl_array_init(&eString, duckLisp->memoryAllocation, sizeof(char), dl_array_strategy_double);
...
dl_error_t duckLisp_emit_brz(duckLisp_t *duckLisp, dl_array_t *assembly, char *label, dl_size_t label_length, int pops) {
	dl_error_t e = dl_error_ok;
	dl_error_t eError = dl_error_ok;
	dl_array_t eString;
	/**/ dl_array_init(&eString, duckLisp->memoryAllocation, sizeof(char), dl_array_strategy_double);
...
dl_error_t duckLisp_emit_brnz(duckLisp_t *duckLisp, dl_array_t *assembly, char *label, dl_size_t label_length, int pops) {
	dl_error_t e = dl_error_ok;
	dl_error_t eError = dl_error_ok;
	dl_array_t eString;
	/**/ dl_array_init(&eString, duckLisp->memoryAllocation, sizeof(char), dl_array_strategy_double);
...
dl_error_t duckLisp_generator_typeof(duckLisp_t *duckLisp, dl_array_t *assembly, duckLisp_ast_expression_t *expression) {
	dl_error_t e = dl_error_ok;
	dl_error_t eError = dl_error_ok;
	dl_array_t eString;
	/**/ dl_array_init(&eString, duckLisp->memoryAllocation, sizeof(char), dl_array_strategy_double);
...
dl_error_t duckLisp_generator_quote_helper(duckLisp_t *duckLisp, dl_array_t *assembly, dl_ptrdiff_t *stack_index, duckLisp_ast_compoundExpression_t *tree) {
	dl_error_t e = dl_error_ok;
	dl_error_t eError = dl_error_ok;
	dl_array_t eString;
	/**/ dl_array_init(&eString, duckLisp->memoryAllocation, sizeof(char), dl_array_strategy_double);
	...
	case duckLisp_ast_type_expression:
		if (tree->value.expression.compoundExpressions_length > 0) {
			...
			for (dl_ptrdiff_t j = tree->value.expression.compoundExpressions_length - 1; j >= 0; --j) {
				e = duckLisp_generator_quote_helper(duckLisp, assembly, &temp_index, &tree->value.expression.compoundExpressions[j]);
				if (e) goto l_cleanup;
...
dl_error_t duckLisp_generator_noscope(duckLisp_t *duckLisp, dl_array_t *assembly, duckLisp_ast_expression_t *expression) {
	dl_error_t e = dl_error_ok;
	dl_error_t eError = dl_error_ok;
	dl_array_t eString;
	/**/ dl_array_init(&eString, duckLisp->memoryAllocation, sizeof(char), dl_array_strategy_double);
	...
	for (dl_ptrdiff_t i = 0; (dl_size_t) i < expression->compoundExpressions_length; i++) {
		...
		case duckLisp_ast_type_expression:
			...
			if (e) goto l_cleanup;
			if (!noPop && (duckLisp->locals_length > startStack_length + ((dl_size_t) i == expression->compoundExpressions_length - 1))) {
...
dl_error_t duckLisp_generator_defun(duckLisp_t *duckLisp, dl_array_t *assembly, duckLisp_ast_expression_t *expression) {
	...
	if (expression->compoundExpressions_length < 3) {
		...
		e = duckLisp_error_pushRuntime(duckLisp, (char *) eString.elements, eString.elements_length * eString.element_size);
		if (e) {
			goto l_cleanup;
		}
	...
	e = duckLisp_register_label(duckLisp, expression->compoundExpressions[1].value.identifier.value,
	...
	// (label function_name)
	e = duckLisp_emit_label(duckLisp, assembly, expression->compoundExpressions[1].value.identifier.value,
							expression->compoundExpressions[1].value.identifier.value_length);
	if (e) goto l_cleanup;
	...
	{		
		...
		if (expression->compoundExpressions[2].type != duckLisp_ast_type_int) {
			...
			for (dl_ptrdiff_t j = 0; (dl_size_t) j < args_list->compoundExpressions_length; j++) {
				...
				/* --duckLisp->locals_length; */
				e = duckLisp_scope_addObject(duckLisp, args_list->compoundExpressions[j].value.identifier.value,
		...
		e = duckLisp_emit_return(duckLisp, assembly, (expression->compoundExpressions[2].type == duckLisp_ast_type_expression
													  ? duckLisp->locals_length - 1
													  /* ? expression->compoundExpressions[2].value.expression.compoundExpressions_length */
													  : 0));
...
dl_error_t duckLisp_generator_multiply(duckLisp_t *duckLisp, dl_array_t *assembly, duckLisp_ast_expression_t *expression) {
	dl_error_t e = dl_error_ok;
	dl_error_t eError = dl_error_ok;
	dl_array_t eString;
	/**/ dl_array_init(&eString, duckLisp->memoryAllocation, sizeof(char), dl_array_strategy_double);
...
dl_error_t duckLisp_generator_divide(duckLisp_t *duckLisp, dl_array_t *assembly, duckLisp_ast_expression_t *expression) {
	dl_error_t e = dl_error_ok;
	dl_error_t eError = dl_error_ok;
	dl_array_t eString;
	/**/ dl_array_init(&eString, duckLisp->memoryAllocation, sizeof(char), dl_array_strategy_double);
...
dl_error_t duckLisp_generator_greater(duckLisp_t *duckLisp, dl_array_t *assembly, duckLisp_ast_expression_t *expression) {
	dl_error_t e = dl_error_ok;
	dl_error_t eError = dl_error_ok;
	dl_array_t eString;
	/**/ dl_array_init(&eString, duckLisp->memoryAllocation, sizeof(char), dl_array_strategy_double);
...
dl_error_t duckLisp_generator_while(duckLisp_t *duckLisp, dl_array_t *assembly, duckLisp_ast_expression_t *expression) {
	...
	if (expression->compoundExpressions[0].type != duckLisp_ast_type_identifier) {
		e = dl_error_invalidValue;
		eError = duckLisp_error_pushRuntime(duckLisp, (char *) eString.elements, eString.elements_length * eString.element_size);
		if (eError) e = eError;
		goto l_cleanup;
	}
...
dl_error_t duckLisp_generator_unless(duckLisp_t *duckLisp, dl_array_t *assembly, duckLisp_ast_expression_t *expression) {
	dl_error_t e = dl_error_ok;
	dl_error_t eError = dl_error_ok;
	dl_array_t eString;
	/**/ dl_array_init(&eString, duckLisp->memoryAllocation, sizeof(char), dl_array_strategy_double);
...
dl_error_t duckLisp_generator_createVar(duckLisp_t *duckLisp, dl_array_t *assembly, duckLisp_ast_expression_t *expression) {
	dl_error_t e = dl_error_ok;
	dl_error_t eError = dl_error_ok;
	dl_array_t eString;
	/**/ dl_array_init(&eString, duckLisp->memoryAllocation, sizeof(char), dl_array_strategy_double);
...
dl_error_t duckLisp_generator_expression(duckLisp_t *duckLisp, dl_array_t *assembly, duckLisp_ast_expression_t *expression) {
	...
	for (dl_ptrdiff_t i = 0; (dl_size_t) i < expression->compoundExpressions_length; i++) {
		...
		case duckLisp_ast_type_expression:
			...
			e = duckLisp_compile_expression(duckLisp, assembly, &currentExpression.value.expression);
			if (e) goto l_cleanup;
			if (!foundInclude && (duckLisp->locals_length > startStack_length + ((dl_size_t) i == expression->compoundExpressions_length - 1))) {
				/* if ((dl_size_t) i != expression->compoundExpressions_length - 1) { */
				/* 	e = duckLisp_emit_move(duckLisp, assembly, startStack_length, duckLisp->locals_length - 1); */
				/* } */
				if (startStack_length != duckLisp->locals_length - 1) {
...
dl_error_t duckLisp_compile_compoundExpression(duckLisp_t *duckLisp, dl_array_t *assembly, char *functionName,
	...
	case duckLisp_ast_type_int:
		...
		break;
	/* case duckLisp_ast_type_float: */
	/* 	e = duckLisp_emit_pushFloat(duckLisp, assembly, &temp_index, compoundExpression->value.floatingPoint.value); */
	/* 	if (e) goto l_cleanup; */
	/* 	temp_type = duckLisp_ast_type_float; */
	/* 	break; */
	case duckLisp_ast_type_string:
	...
	case duckLisp_ast_type_identifier:
		...
		break;
	case duckLisp_ast_type_expression:
		e = duckLisp_compile_expression(duckLisp, assembly, &compoundExpression->value.expression);
		if (e) goto l_cleanup;
		...
		for (dl_ptrdiff_t j = 0; (dl_size_t) j < assembly.elements_length; j++) {
			...
			case duckLisp_instructionClass_pushInteger: {
				...
				case duckLisp_instructionArgClass_type_integer:
					...
					for (dl_ptrdiff_t n = 0; (dl_size_t) n < byte_length; n++) {
						DL_ARRAY_GETADDRESS(currentArgs, dl_uint8_t, n) = (args[0].value.integer >> 8*(byte_length - n - 1)) & 0xFFU;
					}
					break;
				default:
					eError = duckLisp_error_pushRuntime(duckLisp, DL_STR("Invalid argument class. Aborting."));
			...
			case duckLisp_instructionClass_pushSymbol: {
				...
				if ((args[0].type == duckLisp_instructionArgClass_type_integer) &&
					...
					for (dl_ptrdiff_t n = 0; (dl_size_t) n < byte_length; n++) {
						DL_ARRAY_GETADDRESS(currentArgs, dl_uint8_t, n + byte_length) = (args[1].value.integer >> 8*(byte_length - n - 1)) & 0xFFU;
					}
...
dl_error_t duckLisp_init(duckLisp_t *duckLisp) {
	...
	/* No error */ dl_array_init(&duckLisp->symbols_array, duckLisp->memoryAllocation, sizeof(duckLisp_ast_identifier_t), dl_array_strategy_double);
...
dl_error_t duckLisp_loadString(duckLisp_t *duckLisp, unsigned char **bytecode, dl_size_t *bytecode_length,
...

	{
		dl_size_t tempDlSize;
		/**/ dl_memory_usage(&tempDlSize, *duckLisp->memoryAllocation);
		printf("\nCompiler memory usage: %llu/%llu (%llu%%)", tempDlSize, duckLisp->memoryAllocation->size, 100*tempDlSize/duckLisp->memoryAllocation->size);
	}
